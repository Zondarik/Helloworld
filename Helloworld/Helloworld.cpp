...
// Helloworld.cpp: определяет поведение классов для приложения.
//
...
// Единственный объект CHelloworldApp

CHelloworldApp theApp;


// Инициализация CHelloworldApp
...
// Обработчики сообщений CHelloworldApp
...
// Методы загрузки или сохранения настроек CHelloworldApp
